...
const serviceDetails: Record<string, ServiceDetailContent> = {
  'design-web-ui-ux': {
    ...
    heroDescription: "En Côte d'Ivoire, 85% des internautes naviguent sur mobile. Nos designs UI/UX sont pensés mobile-first pour capter l'attention de vos clients dès la première seconde et les guider naturellement vers l'achat.",
    features: [
      { icon: 'layout', title: 'Maquettes sur-mesure', description: "Design unique adapté à votre identité de marque et aux goûts du marché ivoirien. Pas de templates génériques." },
      { icon: 'smartphone', title: 'Mobile-First', description: "Chaque pixel est optimisé pour les écrans de smartphones les plus utilisés à Abidjan — Samsung, iPhone, Tecno, Infinix." },
    ...
    process: [
      { step: 1, title: 'Brief créatif', description: "On échange sur WhatsApp ou en personne à Abidjan pour comprendre votre marque, vos objectifs et votre clientèle cible." },
    ...
    faq: [
      ...
      { question: "Le design sera-t-il adapté aux mobiles ?", answer: "Oui, c'est notre priorité absolue. En Côte d'Ivoire, la majorité du trafic web vient du mobile. Chaque design est pensé et testé mobile-first." }
    ],
  ...
  'developpement-web': {
    ...
    heroDescription: "Nous développons des sites web modernes en Next.js qui se chargent en moins de 2 secondes, même sur les réseaux 3G/4G à Abidjan. Performance, sécurité et SEO intégrés dès la base.",
    features: [
      ...
      { icon: 'globe', title: 'SEO intégré', description: "Chaque page est optimisée pour Google.ci dès le développement. Pas besoin de refaire le travail après." },
      { icon: 'server', title: 'Hébergement fiable', description: "Serveurs performants avec uptime 99.9%, CDN mondial pour un accès rapide depuis toute la Côte d'Ivoire." }
    ],
    process: [
    ...
    faq: [
      { question: "Pourquoi Next.js plutôt que WordPress ?", answer: "Next.js est 5 à 10 fois plus rapide que WordPress, ce qui est crucial en Côte d'Ivoire où la connexion peut être lente. De plus, il offre une sécurité bien supérieure et un meilleur référencement Google." },
      { question: "Combien coûte un site web ?", answer: "Un site vitrine démarre à partir de 350 000 FCFA, un site e-commerce à partir de 750 000 FCFA. Contactez-nous pour un devis personnalisé adapté à votre budget." },
  ...
  'automatisation-business': {
    ...
    heroDescription: "Nous concevons des tunnels de vente (funnels) performants, des systèmes de conversion intelligents et des automatisations marketing pour structurer votre business et multiplier vos revenus de manière autonome en Côte d'Ivoire.",
    features: [
      ...
      { icon: 'credit-card', title: 'Paiements Mobile Money', description: "Intégration d'Orange Money, MTN Money et Wave pour permettre à vos clients ivoiriens de payer en toute simplicité." },
    ...
    faq: [
      ...
      { question: "À qui s'adresse ce service ?", answer: "Ce service est idéal pour les coachs, formateurs, consultants, PME et infopreneurs basés à Abidjan et partout en Afrique francophone qui souhaitent cesser de travailler manuellement et structurer leur croissance." },
      ...
      { question: "Est-il possible d'intégrer Orange Money, MTN MoMo et Wave ?", answer: "Oui, c'est notre spécialité en Côte d'Ivoire. Vos clients pourront payer directement depuis leur téléphone avec leurs comptes Mobile Money locaux." }
    ],
  ...
  'optimisation-seo': {
    ...
    heroHighlight: 'en Côte d\'Ivoire',
    heroDescription: "Positionnez votre entreprise en tête des résultats de recherche Google.ci. Attirez des milliers de visiteurs qualifiés chaque mois sans payer un franc de publicité.",
    features: [
      ...
      { icon: 'key', title: 'Mots-clés locaux', description: "Recherche des termes les plus recherchés par vos clients potentiels à Abidjan, Bouaké, Yamoussoukro et en CI." },
      ...
      { icon: 'link', title: 'Netlinking', description: "Stratégie d'acquisition de liens de qualité auprès de sites ivoiriens et francophones reconnus." },
    ...
    process: [
      { step: 1, title: 'Audit initial', description: "Analyse complète de votre site et de vos concurrents sur Google.ci pour identifier les opportunités." },
    ...
    faq: [
      ...
      { question: "Le SEO est-il efficace en Côte d'Ivoire ?", answer: "Absolument ! De plus en plus d'Ivoiriens utilisent Google pour trouver des produits et services. La concurrence SEO étant encore faible en CI, c'est le moment idéal pour prendre de l'avance." },
    ...
    ctaTitle: "Apparaissez en premier sur Google.ci",
  ...
  'campagnes-publicitaires-ppc': {
    ...
    heroDescription: "Publicité ultra-ciblée sur Google, Facebook, Instagram et TikTok pour toucher vos clients idéaux à Abidjan et partout en Côte d'Ivoire. Chaque franc investi est optimisé.",
    features: [
      { icon: 'target', title: 'Ciblage géographique', description: "Touchez précisément les habitants d'Abidjan, Cocody, Plateau, Yopougon ou de toute autre zone de CI." },
    ...
    stats: [
      { value: '5M+', label: 'FCFA gérés en ads' },
      { value: '3.5x', label: 'ROAS moyen' },
      { value: '-40%', label: 'Coût par lead' },
      { value: '24h', label: 'Premiers résultats' }
    ],
    faq: [
      { question: "Quel budget minimum faut-il pour commencer ?", answer: "Nous recommandons un minimum de 100 000 FCFA/mois de budget publicitaire pour des campagnes Facebook/Instagram, et 150 000 FCFA/mois pour Google Ads." },
  ...
  'boutiques-shopify': {
    ...
    features: [
      ...
      { icon: 'credit-card', title: 'Paiements locaux', description: "Intégration d'Orange Money, Wave, MTN Money et cartes bancaires pour faciliter l'achat de vos clients." },
      { icon: 'package', title: 'Gestion des livraisons', description: "Configuration des zones de livraison à Abidjan et en province avec tarifs automatiques." },
    ...
    stats: [
      ...
      { value: '100%', label: 'Mobile Money intégré' },
    ...
    faq: [
      ...
      { question: "Mes clients pourront payer par Mobile Money ?", answer: "Oui ! Nous intégrons Orange Money, Wave et MTN Money nativement. Vos clients paient en 2 clics depuis leur téléphone." },
      { question: "Combien coûte l'abonnement Shopify ?", answer: "Le plan Basic Shopify coûte environ 20 000 FCFA/mois. C'est un investissement minime comparé au chiffre d'affaires que votre boutique peut générer." },
      { question: "Puis-je vendre en dehors de la Côte d'Ivoire ?", answer: "Absolument ! Shopify gère les devises, langues et frais de livraison internationaux. Vous pouvez vendre dans toute l'Afrique de l'Ouest et au-delà." }
    ],
  ...
  'marketing-digital': {
    ...
    heroDescription: "Stratégie globale d'acquisition et de fidélisation adaptée au marché ivoirien. Réseaux sociaux, emailing, content marketing — on pilote tout pour transformer vos visiteurs en clients fidèles.",
    features: [
    ...
    process: [
      { step: 1, title: 'Audit marketing', description: "Analyse de votre présence digitale actuelle, de vos concurrents et de votre marché cible en CI." },
    ...
    faq: [
      { question: "Quels réseaux sociaux sont importants en Côte d'Ivoire ?", answer: "Facebook reste le réseau n°1 en CI, suivi d'Instagram et TikTok (en forte croissance). LinkedIn est pertinent pour le B2B. Nous vous conseillons les plateformes les plus adaptées à votre activité." },
      ...
      { question: "Quel budget prévoir ?", answer: "Nos accompagnements marketing démarrent à 250 000 FCFA/mois. Le budget publicitaire est en supplément et adapté à vos objectifs." }
    ],
  ...
  'audit-ux-ui': {
    ...
    features: [
      ...
      { icon: 'smartphone', title: 'Test mobile', description: "Analyse approfondie de l'expérience sur les smartphones les plus utilisés en Côte d'Ivoire." },
      { icon: 'zap', title: 'Audit vitesse', description: "Mesure et optimisation du temps de chargement sur les réseaux 3G/4G locaux." },
    ...
    faq: [
      ...
      { question: "Combien ça coûte ?", answer: "Un audit UX/UI complet coûte à partir de 200 000 FCFA. C'est un investissement qui se rembourse rapidement par l'augmentation des conversions." }
    ],
  ...
  'solutions-ecommerce-sur-mesure': {
    ...
    heroHighlight: 'adaptée au marché ivoirien',
    heroDescription: "Plateformes e-commerce robustes et sur-mesure avec intégration native des paiements Mobile Money (Orange Money, Wave, MTN). Vendez en ligne comme les grands, avec les moyens de paiement locaux.",
    features: [
      { icon: 'credit-card', title: 'Mobile Money natif', description: "Orange Money, Wave, MTN Money intégrés nativement. Vos clients paient en 2 taps depuis leur téléphone." },
      { icon: 'truck', title: 'Livraison optimisée', description: "Gestion des zones de livraison à Abidjan et en province avec calcul automatique des frais." },
      ...
      { icon: 'shield', title: 'Sécurité transactions', description: "Paiements sécurisés, protection des données clients et conformité aux normes de la BCEAO." }
    ],
    process: [
      { step: 1, title: 'Analyse métier', description: "Compréhension de votre activité, catalogue produits et spécificités logistiques en CI." },
      ...
      { step: 3, title: 'Développement', description: "Développement sur-mesure avec intégration des APIs de paiement et livraison locaux." },
    ...
    faq: [
      { question: "Pourquoi du sur-mesure plutôt que Shopify ?", answer: "Le sur-mesure permet d'intégrer parfaitement les APIs de paiement ivoiriennes (Wave, Orange Money) et d'adapter le tunnel d'achat aux habitudes locales. C'est idéal pour les besoins complexes." },
      ...
      { question: "Quel est le coût d'une plateforme e-commerce sur-mesure ?", answer: "Les projets e-commerce sur-mesure démarrent à partir de 1 500 000 FCFA selon la complexité. Contactez-nous pour un devis détaillé." }
    ],
  ...
  'optimisation-conversion-par-ia': {
    ...
    faq: [
      ...
      { question: "Quel ROI puis-je attendre ?", answer: "Nos clients constatent en moyenne une augmentation de 35% des conversions en 3 mois. Sur un site e-commerce, cela peut représenter des millions de FCFA de revenus additionnels." }
    ],
