...
export const SITE_CONFIG = {
  ...
  description: 'Agence de Marketing Digital, Automatisation par IA et Commerce Électronique en Côte d\'Ivoire',
  tagline: 'Gagnez du temps et boostez vos ventes grâce à l\'IA',
} as const;
