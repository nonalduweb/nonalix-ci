...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    // par le site (Google Analytics/Tag Manager, chat IA, carte OpenStreetMap, paiement PawaPay).
    ...
    const csp = [
      ...
      "font-src 'self' data:",
      `connect-src 'self' https://api.nonalix-ci.com https://www.google-analytics.com https://www.googletagmanager.com https://www.google.com${isDev ? ' http://localhost:8000 http://localhost:8001 ws://localhost:*' : ''}`,
